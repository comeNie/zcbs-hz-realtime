...
// Generated 2017-5-27 16:16:07 by Hibernate Tools 3.4.0.CR1
 ...
 */
@Entity
@Table(name = "T_CHN_COLLECT_SINGLE_LOG",  uniqueConstraints = { @UniqueConstraint(columnNames = "TXNSEQNO"), @UniqueConstraint(columnNames = "TXID") })
public class ChnCollectSingleLogDO implements java.io.Serializable {

    private static final long serialVersionUID = 1325653723669940532L;
    private long tid;
    ...
    public ChnCollectSingleLogDO(long tid, String msgid, String txid, String transdate, String transtime, String debtorname, String debtoraccountno, String debtorbranchcode, String creditorbranchcode,
            ...
            String comdate, String txnseqno, String notes, String remarks, String transmitleg, String receiver, String tradetype, String communno, String querymsgid) {
        this.tid = tid;
        this.msgid = msgid;
        this.txid = txid;
        this.transdate = transdate;
