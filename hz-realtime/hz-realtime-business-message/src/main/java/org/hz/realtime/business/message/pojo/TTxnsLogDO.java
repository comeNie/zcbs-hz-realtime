...
// Generated 2017-3-23 11:30:35 by Hibernate Tools 3.4.0.CR1
...
/**
 * TTxnsLog generated by hbm2java
 */
@Entity
...
public class TTxnsLogDO implements java.io.Serializable {
    ...
    public TTxnsLogDO(String txnseqno, String txndate, String txntime, String apptype, String busitype, String busicode, Long amount, Long tradcomm, Long txnfee, String riskver, String splitver,
            ...
            String appinst, String appordcommitime, String appordfintime, String tradeseltxn, String retcode, String retinfo, String tradestatflag, String tradetxnflag, String txncode,
            String cashcode, String relate, String retdatetime, String txnseqnoOg, String notes, String remarks, String accmemberid, String apporderstatus, String apporderinfo, String accbusicode,
            String acccoopinstino, String panName, String productcode, String groupcode, String inpanName) {
        this.txnseqno = txnseqno;
    ...
    @Column(name = "ACCORDINST", length = 15)
    ...
    @Column(name = "PAYRETCODE", length = 64)
    ...
    @Column(name = "PAN_NAME", length = 64)
    ...
    @Column(name = "INPAN_NAME", length = 64)
    public String getInpanName() {
        return this.inpanName;
    }
