...
public class TChnCollectSingleLogVO implements java.io.Serializable {

    private static final long serialVersionUID = 4807536089588146181L;
    private long tid;
    ...
    public TChnCollectSingleLogVO() {
    }

    public TChnCollectSingleLogVO(long tid) {
        this.tid = tid;
    }

    public TChnCollectSingleLogVO(long tid, String msgid, String txid, String transdate, String transtime, String debtorname, String debtoraccountno, String debtorbranchcode,
            String creditorbranchcode, String creditorname, String creditoraccountno, Long amount, String purposeproprietary, String endtoendidentification, String summary, String billnumber,
            String rspmsgid, String rspstatus, String rsprejectcode, String rsprejectinformation, String rspdate, String nettingdate, String commsgid, String comstatus, String comrejectcode,
    ...
    public String toString() {
        return "TChnCollectSingleLogVO [tid=" + tid + ", msgid=" + msgid + ", txid=" + txid + ", transdate=" + transdate + ", transtime=" + transtime + ", debtorname=" + debtorname
                + ", debtoraccountno=" + debtoraccountno + ", debtorbranchcode=" + debtorbranchcode + ", creditorbranchcode=" + creditorbranchcode + ", creditorname=" + creditorname
                + ", creditoraccountno=" + creditoraccountno + ", amount=" + amount + ", purposeproprietary=" + purposeproprietary + ", endtoendidentification=" + endtoendidentification
                + ", summary=" + summary + ", billnumber=" + billnumber + ", rspmsgid=" + rspmsgid + ", rspstatus=" + rspstatus + ", rsprejectcode=" + rsprejectcode + ", rsprejectinformation="
